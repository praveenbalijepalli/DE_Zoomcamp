## Batch Processing
   ...
   ```
    ...
    Alternatively, installing findspark and using it like shown in the [code]([url](https://github.com/praveenbalijepalli/DE_Zoomcamp/blob/main/Week5/week_5_batch_processing/week_5_batch_processing.ipynb) can help us use pyspark to work with spark while in our environment.
